package com.mindera.kmpexample.currencyexchange
...
import com.mindera.kmpexample.currencyexchange.currencyexchange.CurrencyExchangeHeaderScene
import com.mindera.kmpexample.currencyexchange.currencyexchange.CurrencyExchangeTabRowScene
import com.mindera.kmpexample.currencyexchange.setting.SettingScene
...
fun HomeScreenScene(onBack: (() -> Unit), navigator: Navigator) {
    ...
    currentState.value.currencyexchange.forEach {
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    ...
                    if (tabClick == 0) {
                        ...
                        CurrencyExchangeScreen(
                            currencies = lastTenState.value.currencyexchange
                        )
                    }
                }
            } else {
